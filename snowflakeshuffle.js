...
let pathArray;
let legend = {
    "Occupied space": new PegPiece([-canvasWidth/2.11, pegRadius-canvasHeight/2], -1, true),
    "Unoccupied space": new PegPiece([-canvasWidth/2.11, 4*pegRadius-canvasHeight/2], -1, false),
    "Selected space" : new PegPiece([-canvasWidth/2.11, 7*pegRadius-canvasHeight/2], -2, true)
}
